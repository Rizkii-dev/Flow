...
import com.example.flow.databinding.FragmentSegementasiHurufNo2Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class SegementasiHurufNo2 : Fragment() {

    private  lateinit var binding: FragmentSegementasiHurufNo2Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSegementasiHurufNo2Binding.inflate(layoutInflater, container, false)

        binding.audioQuestion.setOnClickListener {
            MediaPlayer.create(this.context, R.raw.u_b_i).start()
        }
