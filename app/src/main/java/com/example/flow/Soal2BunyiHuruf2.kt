...
class Soal2BunyiHuruf2 : Fragment() {

    private  lateinit var binding: FragmentSoal2BunyiHuruf2Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSoal2BunyiHuruf2Binding.inflate(layoutInflater, container, false)
