...
class Soal3BunyiSukuKata2 : Fragment() {

    private  lateinit var binding: FragmentSoal3BunyiSukuKata2Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSoal3BunyiSukuKata2Binding.inflate(layoutInflater, container, false)
