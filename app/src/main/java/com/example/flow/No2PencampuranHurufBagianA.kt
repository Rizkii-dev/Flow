...
class No2PencampuranHurufBagianA : Fragment() {

    private  lateinit var binding: FragmentNo2PencampuranHurufBagianABinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentNo2PencampuranHurufBagianABinding.inflate(layoutInflater, container, false)
