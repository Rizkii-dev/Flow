...
class Soal2BunyiSukuKata2 : Fragment() {

    private  lateinit var binding: FragmentSoal2BunyiSukuKata2Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSoal2BunyiSukuKata2Binding.inflate(layoutInflater, container, false)
