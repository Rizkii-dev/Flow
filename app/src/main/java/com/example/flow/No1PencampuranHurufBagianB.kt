...
class No1PencampuranHurufBagianB : Fragment() {

    private  lateinit var binding: FragmentNo1PencampuranHurufBagianBBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentNo1PencampuranHurufBagianBBinding.inflate(layoutInflater, container, false)
