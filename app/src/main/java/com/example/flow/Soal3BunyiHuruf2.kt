...
class Soal3BunyiHuruf2 : Fragment() {

    private  lateinit var binding: FragmentSoal3BunyiHuruf2Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSoal3BunyiHuruf2Binding.inflate(layoutInflater, container, false)
