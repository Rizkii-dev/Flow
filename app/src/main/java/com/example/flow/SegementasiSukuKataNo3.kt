...
import com.example.flow.databinding.FragmentSegementasiSukuKataNo3Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class SegementasiSukuKataNo3 : Fragment() {

    private  lateinit var binding: FragmentSegementasiSukuKataNo3Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSegementasiSukuKataNo3Binding.inflate(layoutInflater, container, false)

        binding.audioQuestion.setOnClickListener {
            MediaPlayer.create(this.context, R.raw.se_pe_da).start()
        }
