...
class No1PencampuranSukuKataBagianA : Fragment() {

    private  lateinit var binding: FragmentNo1PencampuranSukuKataBagianABinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentNo1PencampuranSukuKataBagianABinding.inflate(layoutInflater, container, false)
