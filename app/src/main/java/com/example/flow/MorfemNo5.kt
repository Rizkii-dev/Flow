...
import com.example.flow.databinding.FragmentMorfemNo5Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class MorfemNo5 : Fragment() {

    private  lateinit var binding: FragmentMorfemNo5Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentMorfemNo5Binding.inflate(layoutInflater, container, false)

        binding.button1.setOnClickListener {
            MediaPlayer.create(this.context, R.raw.kerang).start()
        }

        binding.button2.setOnClickListener {
            MediaPlayer.create(this.context, R.raw.keranjang).start()
        }
