...
class No2PencampuranKataBagianA : Fragment() {

    private  lateinit var binding: FragmentNo2PencampuranKataBagianABinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentNo2PencampuranKataBagianABinding.inflate(layoutInflater, container, false)
