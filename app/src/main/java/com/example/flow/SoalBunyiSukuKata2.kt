...
class SoalBunyiSukuKata2 : Fragment() {

    private  lateinit var binding: FragmentSoalBunyiSukuKata2Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSoalBunyiSukuKata2Binding.inflate(layoutInflater, container, false)
