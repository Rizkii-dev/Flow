...
class No3PencampuranSukuKataBagianB : Fragment() {

    private  lateinit var binding: FragmentNo3PencampuranSukuKataBagianBBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentNo3PencampuranSukuKataBagianBBinding.inflate(layoutInflater, container, false)
