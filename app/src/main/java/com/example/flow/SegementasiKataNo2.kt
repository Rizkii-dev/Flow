...
import com.example.flow.databinding.FragmentSegementasiKataNo2Binding
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class SegementasiKataNo2 : Fragment() {

    private  lateinit var binding: FragmentSegementasiKataNo2Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSegementasiKataNo2Binding.inflate(layoutInflater, container, false)

        binding.audioQuestion.setOnClickListener {
            MediaPlayer.create(this.context, R.raw.faza_main_bola).start()
        }
        ...
        binding.anwerBtn3.setOnClickListener {
            MediaPlayer.create(this.context, R.raw.no7).start()
            wrongAnwer()
        }
