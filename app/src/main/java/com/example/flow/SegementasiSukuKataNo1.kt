...
class SegementasiSukuKataNo1 : Fragment() {

    private  lateinit var binding: FragmentSegementasiSukuKataNo1Binding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSegementasiSukuKataNo1Binding.inflate(layoutInflater, container, false)

        binding.audioQuestion.setOnClickListener {
            MediaPlayer.create(this.context, R.raw.da_un).start()
        }
