...
class No3PencampuranHurufBagianA : Fragment() {

    private  lateinit var binding: FragmentNo3PencampuranHurufBagianABinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentNo3PencampuranHurufBagianABinding.inflate(layoutInflater, container, false)
