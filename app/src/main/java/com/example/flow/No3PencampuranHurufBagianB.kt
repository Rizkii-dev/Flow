...
class No3PencampuranHurufBagianB : Fragment() {

    private  lateinit var binding: FragmentNo3PencampuranHurufBagianBBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentNo3PencampuranHurufBagianBBinding.inflate(layoutInflater, container, false)
