...
class No1PencampuranSukuKataBagianB : Fragment() {

    private  lateinit var binding: FragmentNo1PencampuranSukuKataBagianBBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentNo1PencampuranSukuKataBagianBBinding.inflate(layoutInflater, container, false)
